...
//        tableFillList.add(new TableFill("ASDD_SS", FieldFill.INSERT_UPDATE));
        ...
        mpg.setDataSource (
                ...
                new DataSourceConfig ()
                        ...
                        .setUsername ( "root" )
                        .setPassword ( "T123456t" )
                        .setUrl ( "jdbc:mysql://127.0.0.1:3306/mst?characterEncoding=utf8" )
        );
        mpg.setStrategy (
                // 策略配置
                new StrategyConfig ()
                        ...
                        // 自定义 controller 父类
//                        .setSuperControllerClass ( "com.segasoft.ol.group." + packageName + ".controller" +
//                                ".AbstractController" )
        ...
        mpg.setPackageInfo (
                ...
                new PackageConfig ()
                        //.setModuleName("User")
                        .setParent ( "com.zzw.demo." + packageName )// 自定义包路径
